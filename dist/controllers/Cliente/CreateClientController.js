...
const CreateClientService_1 = require("../../services/Cliente/CreateClientService");
class CreateClientController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const client = yield createClientService.execute({ name, email, status_email, numero_maquina, fiscal, sistem, type, obs });
