...
var CreateClientService = /** @class */ (function () {
    ...
    CreateClientService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, status = _a.status;
        return __awaiter(this, void 0, void 0, function () {
            var userAlreadyExists, Client;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma_1["default"].client.findFirst({
                                where: {
                                    name: name,
                                    email: email
                                }
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_1["default"].client.create({
                                data: {
                                    name: name,
                                    email: email,
                                    status: status
